...
EXPOSE 3000
ENV PORT=3000
LABEL org.opencontainers.image.source=https://github.com/Unluckymichell/adventskalender
LABEL org.opencontainers.image.description="Advenzkalender - Next JS"
